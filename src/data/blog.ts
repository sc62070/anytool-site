...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: 'CSS Gradients: A Complete Visual Guide',
    excerpt: 'Master linear, radial, and conic gradients with practical examples and our free gradient generator tool.',
    date: '2026-08-28',
    readTime: '5 min',
    category: 'Design',
    author: 'AnyTool Team',
    ...
    content: [
      ...
      '',
      'CSS gradients let you create smooth transitions between two or more colors without images. They are rendered by the browser, so they load instantly and scale perfectly at any resolution.',
      '',
      '### Three Types of Gradients',
      '',
      '1. **Linear Gradient** — colors flow in a straight line',
      ...
      '```',
      '',
      'The first value is the angle (direction). The color stops define where colors transition.',
      '',
      ...
      '',
      'Our [CSS Gradient Generator](/tools/css-gradient) lets you visually build gradients with color pickers, angle sliders, and live preview. Copy the CSS with one click.',
    ].join('\n'),
    links: [
  ...
  },
  {
    ...
    title: 'How to Decode JWT Tokens: A Developer Guide',
    excerpt: 'Learn what JWT tokens contain, how to decode them, and why every developer should know this.',
    date: '2026-08-28',
    readTime: '4 min',
    category: 'Developer',
    author: 'AnyTool Team',
    ...
    content: [
      '## What is a JWT?',
      '',
      'JWT (JSON Web Token) is a compact, URL-safe token format used for authentication and data exchange. It consists of three parts separated by dots: header, payload, and signature.',
      '',
      '### JWT Structure',
      '',
      '`xxxxx.yyyyy.zzzzz`',
      ...
      '### Decoding a JWT',
      '',
      'Each part is Base64URL encoded. To decode:',
      '',
      ...
      '',
      'The payload is readable by anyone. Never put sensitive data (passwords, secrets) in a JWT. The signature only verifies integrity — it doesn\'t hide data.',
      '',
      '### Decode Tokens Online',
      '',
  ...
  },
  {
    ...
    title: 'Flexbox Cheatsheet: Every Property Explained',
    excerpt: 'A complete visual reference for CSS Flexbox with interactive examples using our Flexbox Playground.',
    date: '2026-08-28',
    readTime: '6 min',
    category: 'Design',
    author: 'AnyTool Team',
    ...
    content: [
      ...
      '| `justify-content` | `flex-start`, `center`, `space-between`, `space-around`, `space-evenly` | Alignment on main axis |',
      ...
      '| `align-self` | `auto`, `flex-start`, `center`, `flex-end` | Override align-items |',
      '',
      '### Common Patterns',
      '',
      '```css',
      ...
      '### Try It Live',
      '',
      'Use our [Flexbox Playground](/tools/flexbox-playground) to visually experiment with all these properties. See changes in real-time as you adjust the controls.',
    ].join('\n'),
    links: [
  ...
  },
  {
    ...
    title: 'Password Security: What You Need to Know in 2026',
    excerpt: 'Learn how to create strong passwords, why password managers matter, and check your password strength.',
    date: '2026-08-28',
    readTime: '4 min',
    category: 'Security',
    author: 'AnyTool Team',
    ...
    content: [
      '## Why Password Security Matters',
      '',
      'In 2026, over 80% of data breaches involve weak or reused passwords. A strong password is your first line of defense.',
      '',
      '### What Makes a Password Strong?',
      '',
      ...
      '- **Randomness**: Avoid dictionary words, names, dates',
      '',
      ...
      '',
      'Our [Password Generator](/tools/password-generator) creates random, strong passwords up to 128 characters. You can customize length, character types, and exclude ambiguous characters.',
      '',
      '### Check Your Password',
      '',
      'Use our [Password Strength Checker](/tools/password-strength) to see how secure your current passwords are.',
    ].join('\n'),
    links: [
      { label: 'Have I Been Pwned', url: 'https://haveibeenpwned.com/' },
      { label: 'NIST Password Guidelines', url: 'https://pages.nist.gov/800-63-3/sp800-63b.html' },
  ...
  },
  {
    ...
    title: 'PDF Tools Every Developer Needs (All Browser-Based)',
    excerpt: 'Merge, split, rotate, compress, and convert PDFs without uploading anything. Here\'s how.',
    date: '2026-08-28',
    readTime: '4 min',
    category: 'Office',
    author: 'AnyTool Team',
    ...
    content: [
      ...
      '',
      'Most PDF tools require uploading your files to a server. This is a privacy risk — you never know what happens to your documents after upload. Browser-based tools process everything locally.',
      '',
      '### Available PDF Tools',
      '',
      '- **[Merge PDF](/tools/pdf-merge)**: Combine multiple PDFs into one',
      '- **[Split PDF](/tools/pdf-split)**: Extract specific pages',
      '- **[Rotate PDF](/tools/rotate-pdf)**: Rotate pages by 90°, 180°, or 270°',
      '- **[Compress PDF](/tools/compress-pdf)**: Reduce file size',
      '- **[Image to PDF](/tools/image-to-pdf)**: Convert images to PDF',
      '- **[PDF Viewer](/tools/pdf-viewer)**: View PDFs without downloading',
      '',
      '### How It Works',
      '',
      'These tools use JavaScript libraries like pdf-lib and pdf.js that run entirely in your browser. Your files are never uploaded anywhere.',
      '',
      '### Common Use Cases',
      '',
      '1. Merging bank statements into one PDF',
      '2. Extracting specific pages from a contract',
      '3. Rotating scanned documents that are sideways',
      '4. Compressing large PDFs before emailing',
      '5. Converting screenshots to PDF for documentation',
      '',
      '### Try All PDF Tools',
      '',
      'Visit our [PDF category](/tools/pdf-merge) to access all browser-based PDF tools.',
    ].join('\n'),
    links: [
