  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">CSV to JSON</h1>
      </div>
      <p className="text-gray-600 dark:text-gray-400 mb-8">Convert CSV data to JSON format instantly in your browser.</p>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <textarea readOnly value={json} className="w-full h-80 p-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 font-mono text-sm resize-y" placeholder="JSON output will appear here..." />
        </div>
      </div>
