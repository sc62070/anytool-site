...
export default function MarkdownPreview() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-600 mb-8">Write markdown on the left, see the rendered preview on the right.</p>
      ...
      <div className="grid md:grid-cols-2 gap-4 bg-white rounded-xl border border-gray-200 p-4">
        <div>
          ...
          <textarea
            ...
            className="w-full h-[500px] p-4 border border-gray-300 rounded-xl text-sm font-mono resize-none focus:ring-2 focus:ring-indigo-500 outline-none"
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Preview</label>
          <div
            className="h-[500px] overflow-y-auto p-4 border border-gray-300 rounded-xl prose prose-sm max-w-none"
