...
export default function UuidGenerator() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-600 mb-8">Generate random UUIDs (v4) for your applications.</p>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <input
            ...
            className="w-20 p-2 border border-gray-300 rounded-lg text-center focus:ring-2 focus:ring-indigo-500 outline-none"
          />
          ...
          <div className="space-y-2">
            {uuids.map((uuid, i) => (
              <div key={i} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                <span className="font-mono text-sm text-gray-800 flex-1">{uuid}</span>
                <button onClick={() => handleCopy(uuid, String(i))} className="p-1.5 text-gray-400 hover:text-indigo-600">
