...
export default function JsonFormatter() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-600 mb-8">Format, validate, minify, and beautify your JSON data.</p>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          ...
          <textarea
            ...
            className="w-full h-72 p-4 border border-gray-300 rounded-xl text-sm font-mono resize-y focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
          />
        </div>
        <div>
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full h-72 p-4 border border-gray-300 rounded-xl text-sm font-mono bg-gray-50 resize-y"
            />
            {output && (
              <button onClick={handleCopy} className="absolute top-3 right-3 p-2 text-gray-400 hover:text-indigo-600 transition-colors">
      ...
      <div className="flex gap-3 mt-6">
        ...
        <button onClick={minify} className="bg-gray-200 text-gray-700 px-6 py-2.5 rounded-lg font-medium hover:bg-gray-300 transition-colors">
          Minify
        </button>
